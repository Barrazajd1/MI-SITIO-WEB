    ...
    <div className="min-h-screen bg-[#f4f8fb]">
      ...
      <header className="bg-white border-b border-[#cae4f2] sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold text-[#2e435e]">Papelera</span>
          </div>
      ...
      <main className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="bg-white border border-orange-100 rounded-2xl px-6 py-5 flex items-center gap-4 mb-8">
          ...
          <div>
            <p className="font-bold text-[#2e435e]">Proyectos en papelera</p>
            <p className="text-sm text-gray-400">
              {trashed?.length ?? 0} proyecto{(trashed?.length ?? 0) !== 1 ? "s" : ""} — puedes restaurarlos o eliminarlos definitivamente.
            </p>
          </div>
        ...
        {!trashed || trashed.length === 0 ? (
          <div className="bg-white border border-dashed border-[#cae4f2] rounded-2xl p-16 text-center">
            ...
            <p className="text-gray-300 text-sm mt-1">Los proyectos que muevas a la papelera aparecerán aquí.</p>
          </div>
        ) : (
